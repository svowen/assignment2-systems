...
from benchmarking_script_nsys import init, benchmark_lm_forward_backward
...
context_length_ls = [128, 256, 512, 1024]     # standard sequence length
rope_theta = 10000        # standard RoPE base
batch_size = 1            # start safe (avoid OOM)

for i in model_configs:
    for context_length in context_length_ls:
        val = model_configs[i]
        print(i, val)
